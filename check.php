<?php
$link = mysqli_connect('https://databases-auth.000webhost.com/', 'id12666445_ulfh', '+gRp3JZO6t2rC~x'); //host, user, pass

$database = mysqli_select_db($link, "id12666445_ulf"); //Set here your db name
